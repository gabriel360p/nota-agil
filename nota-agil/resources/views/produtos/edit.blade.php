        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 text-center">
                    <span class="display-5">Editar Produto</span>
                </div>

                <form action="{{ route('produtos.update',$produto->id) }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-3">
                        <label for="" class="form-label">Nome do Produto</label>
                        <input type="text" class="form-control" value="{{ $produto->nome  }}" required name="nome"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" value="{{ $produto->preco }}" required name="preco"
